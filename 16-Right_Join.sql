...
SELECT *
FROM tb3 RIGHT JOIN tb2
ON tb3.col10 = tb2.col1;

SELECT *
FROM tb4 RIGHT JOIN tb5
ON tb4.post = tb5.colA;


-- Syntax-2:
SELECT *
FROM tb1 RIGHT OUTER JOIN tb3
ON tb1.col1 = tb3.col10;
...
SELECT *
FROM tb3 RIGHT OUTER JOIN tb2
ON tb3.col10 = tb2.col1;

SELECT *
FROM tb4 RIGHT OUTER JOIN tb5
ON tb4.post = tb5.colA;
